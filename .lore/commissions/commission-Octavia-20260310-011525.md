...
dependencies: []
linked_artifacts:
  - .lore/plans/system-model-defaults.md
...
---
Implementation plan written to `.lore/plans/system-model-defaults.md`.
