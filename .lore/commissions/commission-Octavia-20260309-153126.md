...
---
Plan written to `.lore/plans/infrastructure/local-model-support.md`. The plan breaks local model support into 11 ordered implementation steps across five focused commissions.
