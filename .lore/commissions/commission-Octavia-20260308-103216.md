...
---
Wrote the mail reader toolbox spec at `.lore/specs/workers/guild-hall-mail-reader-toolbox.md`. The spec defines `guild-hall-email`, a domain toolbox package that gives workers read-only access to the user's Fastmail inbox via JMAP.
