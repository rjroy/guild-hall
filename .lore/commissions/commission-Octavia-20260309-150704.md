...
---
Wrote the local model support spec at `.lore/specs/infrastructure/local-model-support.md` with 30 requirements (REQ-LOCAL-1 through REQ-LOCAL-30).
