...
| Commission UI | Frontend reads commission state through Layer 2's public interface | [Spec: guild-hall-views](.lore/specs/ui/guild-hall-views.md) |
...
- [Spec: Guild Hall Commissions](.lore/specs/commissions/guild-hall-commissions.md): The original commission spec (REQ-COM-1 through REQ-COM-32). All behavioral requirements carry forward.
