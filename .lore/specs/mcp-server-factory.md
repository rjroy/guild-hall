...
- **Phase I Spec** (`.lore/specs/guild-hall-phase-1.md`): REQ-GH1-8 and REQ-GH1-29 define direct tool invocation, which requires MCPServerFactory. This spec completes the final Phase I success criterion.
