...
**Revision note (2026-03-20):** Proposal 7 (Commission Narrative) promoted from Filed Observations after audience feedback that brainstorms should not self-censor based on implementation complexity. The original observation framed commission transcripts as an infrastructure problem; the proposal reframes it as a knowledge problem with a different solution shape.
...
| # | Title | Scope | File |
|---|-------|-------|------|
| 1 | Decisions Surface | Small | `decisions-surface.md` |
| 2 | Commission History Search | Medium | `commission-history-search.md` |
| 3 | Worker Performance Feedback Loop | Small | `worker-performance-feedback-loop.md` |
| 4 | Commission Templates | Medium | `commission-templates.md` |
| 5 | Cross-Commission Artifact Graph | Medium | `cross-commission-artifact-graph.md` |
| 6 | Standing Delegation | Large | `standing-delegation.md` |
| 7 | Commission Narrative | Medium | `commission-narrative.md` |

## Filed Issues

| Title | Severity | File |
|-------|----------|------|
| Halted Commission UI Gap | Moderate | `.lore/issues/halted-commission-ui-gap.md` |
| Memory Budget Visibility | Low | `.lore/issues/memory-budget-visibility.md` |
