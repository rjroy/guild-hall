...
**Spec**: `.lore/specs/project-scoped-meetings.md`
...
Launch a sub-agent that reads the spec at `.lore/specs/project-scoped-meetings.md`, reviews the implementation, and flags any requirements not met. This step is not optional.
