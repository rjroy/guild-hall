...
Launch a sub-agent that reads the spec at `.lore/specs/guild-hall-mail-reader-toolbox.md`, reviews the implementation against all 25 requirements, and flags any that are not met. This step is not optional.
