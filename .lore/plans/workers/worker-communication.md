...
**Spec**: `.lore/specs/workers/worker-communication.md`
**Layer architecture**: `.lore/specs/commissions/commission-layer-separation.md`
...
**Commission layer architecture** (from `.lore/specs/commissions/commission-layer-separation.md`):
...
Launch a sub-agent that reads the spec at `.lore/specs/workers/worker-communication.md`, reviews the implementation, and flags any requirements not met. This step is not optional.
