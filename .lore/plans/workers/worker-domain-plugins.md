...
date: 2026-03-07
status: executed
tags: [architecture, workers, plugins, packages]
...
**Spec**: `.lore/specs/workers/worker-domain-plugins.md`
...
Launch a sub-agent that reads the spec at `.lore/specs/workers/worker-domain-plugins.md`, reviews the implementation, and flags any requirements not met. This step is not optional.
