...
**Spec**: `.lore/specs/local-model-support.md`
**Issue**: `.lore/issues/local-model-support.md`
**Brainstorm**: `.lore/brainstorm/model-selection.md`
**Foundation**: `.lore/plans/model-selection.md` (already implemented)
...
The model-selection plan (`.lore/plans/model-selection.md`) is already implemented. That plan is the foundation:
