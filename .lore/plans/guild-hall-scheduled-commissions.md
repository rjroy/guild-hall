...
Launch a sub-agent that reads the spec at `.lore/specs/guild-hall-scheduled-commissions.md`, reviews the implementation across all modified files, and flags any requirements not met. This step is not optional.
