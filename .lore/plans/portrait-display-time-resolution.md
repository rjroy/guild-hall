...
Launch a sub-agent that reads `.lore/specs/worker-identity-and-personality.md` (specifically the identity flow section), `.lore/specs/guild-hall-views.md` (REQ-VIEW-3, REQ-VIEW-28, REQ-VIEW-12), and reviews the implementation. Verify:
