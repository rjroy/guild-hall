...
From `.lore/plans/worker-dispatch.md`, Pre-Step: "Per the Phase 1 retro lesson (verify SDK APIs against the actual 0.2.45 package before building), examine the createSdkMcpServer() function signature..."
