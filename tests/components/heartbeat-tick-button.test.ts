...
import { tickNowLabel } from "@/web/components/dashboard/WorkspaceSidebar";
...
describe("WorkspaceSidebar module exports", () => {
  test("default export is a function (the component)", async () => {
    const mod = await import("@/web/components/dashboard/WorkspaceSidebar");
...
describe("heartbeat API proxy routes", () => {
  test("tick route module exports POST handler", async () => {
    const mod = await import("@/web/app/api/heartbeat/[projectName]/tick/route");
    expect(typeof mod.POST).toBe("function");
  });

  test("status route module exports GET handler", async () => {
    const mod = await import("@/web/app/api/heartbeat/[projectName]/status/route");
