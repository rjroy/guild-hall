...
import ArtifactProvenance from "@/apps/web/components/artifact/ArtifactProvenance";
import type { Attribution } from "@/apps/web/components/artifact/ArtifactProvenance";
import { resolveAttribution } from "@/apps/web/lib/resolve-attribution";
import ArtifactContent from "@/apps/web/components/artifact/ArtifactContent";
import ArtifactDetailLayout from "@/apps/web/components/artifact/ArtifactDetailLayout";
import MetadataSidebar from "@/apps/web/components/artifact/MetadataSidebar";
import ImageArtifactView from "@/apps/web/components/artifact/ImageArtifactView";
import ImageMetadataSidebar from "@/apps/web/components/artifact/ImageMetadataSidebar";
