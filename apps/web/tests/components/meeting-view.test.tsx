...
import ErrorMessage from "@/apps/web/components/meeting/ErrorMessage";
import type { ToolUseEntry } from "@/lib/types";
import type { ChatMessage } from "@/apps/web/components/meeting/types";
...
describe("MessageBubble", () => {
  ...
  let MessageBubble: typeof import("@/apps/web/components/meeting/MessageBubble").default;
  ...
  test("renders user message with user-side alignment class", async () => {
    const { default: MB } = await import("@/apps/web/components/meeting/MessageBubble");
    MessageBubble = MB;
...
describe("StreamingMessage", () => {
  test("renders WorkerPortrait with correct props", async () => {
    const { default: SM } = await import("@/apps/web/components/meeting/StreamingMessage");
