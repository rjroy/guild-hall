...
import CommissionLinkedArtifacts from "@/apps/web/components/commission/CommissionLinkedArtifacts";
...
import {
  ...
  USER_EVENTS,
  MANAGER_EVENTS,
} from "@/apps/web/components/commission/CommissionTimeline";
...
describe("CommissionHeader type contract", () => {
  ...
  test("module is importable", async () => {
    const mod = await import("@/apps/web/components/commission/CommissionHeader");
...
describe("CommissionPrompt Markdown rendering", () => {
  ...
  test("CommissionPrompt module imports ReactMarkdown", async () => {
    ...
    const mod = await import("@/apps/web/components/commission/CommissionPrompt");
    expect(mod.default).toBeDefined();
    expect(typeof mod.default).toBe("function");
  });
...
describe("CommissionView type contract", () => {
  ...
  test("CollapsibleSidebar is importable", async () => {
    const mod = await import("@/apps/web/components/ui/CollapsibleSidebar");
    expect(mod.default).toBeDefined();
    expect(typeof mod.default).toBe("function");
  });

  test("CommissionView module is importable", async () => {
    const mod = await import("@/apps/web/components/commission/CommissionView");
    expect(mod.default).toBeDefined();
    expect(typeof mod.default).toBe("function");
  });
