...
import { collectRunnerText } from "@/apps/daemon/lib/sdk-text";
import { MANAGER_WORKER_NAME } from "@/apps/daemon/services/manager/worker";
      ...
      tool(
        ...
        async (args) => {
          try {
            ...
            if (shouldDispatch) {
              try {
                const id = result.commissionId as import("@/apps/daemon/types").CommissionId;
