...
import { createBriefingRefreshService } from "@/apps/daemon/services/briefing-refresh";
import type { BriefingRefreshDeps } from "@/apps/daemon/services/briefing-refresh";
